...
const HeroWidget = () => {
  return (
    <div className="flex items-center justify-between py-10 pl-6 bg-superego-grey first:prose-headings:text-superego-light-0">
      <Heading
        type="h2"
        spacing="none"
      ...
      >
        ...
        <br />{' '}
        <span className="text-superego-green">
          {' '}
