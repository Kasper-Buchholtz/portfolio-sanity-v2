    ...
    <div className="h-full p-6 bg-light-0">
        ...
        <div className="space-y-4">
          {posts.map((post, index) => (
            ...
            >
              ...
              <div className="flex flex-col justify-center pl-4 prose-p:text-superego-grey">
      ...
      <div className="mt-6">
        <a
          ...
          target="_blank"
          className="gap-4 px-6 py-2 text-sm font-medium transition-colors rounded-full bg-superego-green text-superego-light-light hover:bg-superego-green/90 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
        >
          Se alle
        </a>
      </div>
